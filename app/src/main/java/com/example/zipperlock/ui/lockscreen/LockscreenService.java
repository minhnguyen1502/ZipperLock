...
public class LockscreenService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        stateRecever(true);
        showNotification();
        startForeground(((MyApplication) getApplication()).notificationId, notification);
    ...
    public void onDestroy() {
        stateRecever(false);
        mNM.cancel(((MyApplication) getApplication()).notificationId);
    }
    ...
    private Notification showNotification() {
        ...
        mNM.notify(((MyApplication) getApplication()).notificationId, notification);
        return notification;
    }
